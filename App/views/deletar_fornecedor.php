                ...
                <div class="flex h-screen">
                    <div class="w-full max-w-md mx-auto p-8 md:py-12 lg:w-1/2 self-center">
                        <form action="" method="POST">
                            <h1  class="text-[#3A4374] font-bold text-center text-2xl mb-4" > Deletar Fornecedor</h1>
                            <div class="">
                                <div>
                                ...
                                <div>
                                    ...
                                    <input value="<?= buscar_var("endereco", $fornecedor->endereco) ?> " class="w-full p-[0.7rem] rounded-md" type="text" name="endereco">
                                </div>
                            </div>                           
                            <button type="submit" class="bg-[#AD1FEA] p-[0.7rem] w-full text-white font-medium rounded-md mt-4">Eliminar</button>
                        </form>
                    </div>
                </div>
            </div>
